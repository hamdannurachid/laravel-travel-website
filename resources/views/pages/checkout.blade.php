                    ...
                    <div class="card card-details">
                                    ...
                                    <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('checkout-remove',$detail->id)}} ">
                                                    <img src="{{ url ('frontend/images/ic_close@2x.png') }}" alt="">
                                                </a>
                                            </td>
                                        </tr>
                                    @empty
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" action="{{ route('checkout-create', $item->id)}} " method="POST">
                                ...
                                <input type="text" name="nationality" class="form-control mb-2 mr-sm-2" id="nationality" placeholder="Nationality" required style="width:50px">

                                <label for="is_visa" class="sr-only">Visa</label>
                                <select name="is_visa" id="is_visa" class="form-control custom-select mb-2 mr-sm-2" required>
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <input type="text" class="form-control datepicker" id="doePassport" placeholder="DOE Passport" name="doe_passport">
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-informations">
                            ...
                            <tr>
                                <th width="50%">Total <small>(+Unique Code)</small></th>
                                <td width="50%" class="text-right text-total">
                                    <label class="text-blue">$ {{ $item->transaction_total }},</label>
                                    <label class="text-orange">{{ mt_rand(0,99) }}</label>
                                </td>
                            </tr>
